...
namespace ASP.NET_MVC_A4.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryId,AccessoryName,AccessoryDesc,AccessoryPrice")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryId,AccessoryName,AccessoryDesc,AccessoryPrice")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
